...
public class EventController {
    ...
    public ResponseEntity<Page<EventDTO>> getEvents(
		...
		//@RequestParam(value = "place",          defaultValue = "") String namePlace,	        
		@RequestParam(value = "startDate",      defaultValue = "") String startDate,
	    @RequestParam(value = "description",    defaultValue = "") String description

	){
		PageRequest pageRequest = PageRequest.of(page, linesPerPage, Direction.valueOf(direction),orderBy);
        Page<EventDTO> list = eventService.getEvents(pageRequest, name, /*namePlace,*/ startDate, description);
	...
	public ResponseEntity<Void> returnTicket(@PathVariable Long eventId, @PathVariable Long ticketId){
